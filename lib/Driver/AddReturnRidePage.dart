...
class _AddReturnRidePageState extends State<AddReturnRidePage> {
  ...
  // Function to get today and tomorrow's date
  List<String> getTodayAndTomorrowDates() {
  ...
  Widget build(BuildContext context) {
    List<String> todayAndTomorrowDates = getTodayAndTomorrowDates();

    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.deepPurple,
        title: const Text(
          "Returning from Faculty Ride",
            ...
            Form(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Driver Mobile Number for Contact:",
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                  TextFormField(
                  ...
                  DropdownButtonFormField(
                    ...
                    items: todayAndTomorrowDates.map((date) {
                      return DropdownMenuItem(
                        value: date,
                        child: Text(date),
                      );
